...
public class otherPaymentDefaulters extends AppCompatActivity implements defaulterCA.TenantssAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.other_payment_defaulters);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Other Payment Defaulters ");
    ...
    private void fetchTenants() {
        String URL = URL_CONNECTOR+"pullOtherPaymentdefaulters.php";
        StringRequest request = new StringRequest(StringRequest.Method.POST,URL,
                new Response.Listener<String>() {
                    @Override //relativelayoutDisplayNothing
                    public void onResponse(String response) {
                        System.out.println("REsponse defaulters 777777777777 "+response+" size "+response.length());
    ...
    public void onTenantSelected(final defaulterDMC tenant) {
        ...
        mBuilder = new AlertDialog.Builder(otherPaymentDefaulters.this);
        ...
        mBuilder.setSingleChoiceItems(paymentmethodslist, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    case 0:
                        makepayments(tenant.getPaidamount(), tenant.getHousepaymentid(), tenant.getAmount(),otherPaymentDefaulters.this );
                        break;
                    case 1:
                        ...
                        Intent rent= new Intent(otherPaymentDefaulters.this, otherspaymentHistory.class);
                        startActivity(rent);
                        break;
                    default:
                        break;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (result.equals("success")){
                                ...
                                Intent intents = new Intent(context,otherPaymentDefaulters.class);

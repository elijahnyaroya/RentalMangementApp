...
public class waterPaymentHistory extends AppCompatActivity implements tenanthistoryCA.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.water_payment_history);

        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        relativelayoutDisplayNothing = findViewById(R.id.relativelayoutDisplayNothing);
        recyclerView.setLayoutManager(new LinearLayoutManager(waterPaymentHistory.this));
        ...
        try {
            ...
            Glide.with(waterPaymentHistory.this).load(tenantImage).into(thumbnail);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.rent:
                        Intent openactivity = new Intent(waterPaymentHistory.this,tenantpaymentHistory.class);

                        finish();
                        startActivity(openactivity);
                        break;
                    case R.id.water:
                        Intent openactivity4 = new Intent(waterPaymentHistory.this,waterPaymentHistory.class);
                        finish();
                        startActivity(openactivity4);
                        break;
                    case R.id.others:
                        Intent openactivity3 = new Intent(waterPaymentHistory.this,otherspaymentHistory.class);
                        finish();
    ...
    private void fetchTenantsHistory() {
        String url = URL_CONNECTOR+"pullindividualWaterDefaulters.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mAdapter = new tenanthistoryCA("waterPaymentHistory",waterPaymentHistory.this,waterPaymentHistory.this,tenantList);
                            recyclerView.setAdapter(mAdapter);
                            mAdapter.setOnItemClickListener(waterPaymentHistory.this);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public void onItemClick(int position) {
        ...
        if (amountPaid==totalAmount){
            ...
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(waterPaymentHistory.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (result.equals("success")){
                                ...
                                Intent intents = new Intent(context,waterPaymentHistory.class);
                                finish();

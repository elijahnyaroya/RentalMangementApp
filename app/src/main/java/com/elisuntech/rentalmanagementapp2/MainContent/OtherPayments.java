...
import com.elisuntech.rentalmanagementapp2.CA.otherpaymentCA;
...
public class
OtherPayments extends AppCompatActivity implements otherpaymentCA.otherpaymentAdapterListener {
    private static final String TAG = OtherPayments.class.getSimpleName();
    private RecyclerView recyclerView;
    private List<otherpaymentDMC> tenantList;
    private otherpaymentCA mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.other_payments);
        ...
        getSupportActionBar().setTitle("Other Payments");
        ...
        mAdapter = new otherpaymentCA(this, tenantList, this);
                    ...
                    Snackbar.make(mysnackbarView, "You need to renew your subscription", Snackbar.LENGTH_LONG)
                            .setAction("Pay now ", new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    sharedMethod.makePayments("appUserPayment", OtherPayments.this);
                                }
                            }).show();
                } else {
                    if (menuItem.getTitle().equals("Rent Defaulters")) {
                        startActivity(new Intent(OtherPayments.this, rentDefaulter.class));
                    } else if (menuItem.getTitle().equals("Water bill Defaulters")) {
                        startActivity(new Intent(OtherPayments.this, waterDefaulters.class));
                    } else if (menuItem.getTitle().equals("Other Payment Defaulter")) {
                        startActivity(new Intent(OtherPayments.this, otherPaymentDefaulters.class));
                    } else {
                        //
                    }
                }
    ...
    private void fetchTenants() {
        String URL = URL_CONNECTOR+"pullotherpaymentstenant.php";

        StringRequest request = new StringRequest(StringRequest.Method.POST,URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        System.out.println("REsponse pullotherpaymentstenant.php "+response);
                        ...
                        List<otherpaymentDMC> items = new Gson().fromJson(response.toString(), new TypeToken<List<otherpaymentDMC>>() {
                        }.getType());
    ...
    @Override
    public void onTenantSelected(final otherpaymentDMC tenant) {
        ...
        mBuilder = new AlertDialog.Builder(OtherPayments.this);
        ...
        mBuilder.setSingleChoiceItems(paymentmethodslist, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //Toast.makeText(OtherPayments.this, "Value "+which, Toast.LENGTH_SHORT).show();
                switch (which) {
                    case 0:
                        makepaymentOtherpayment(tenant.getPaidamount(),tenant.getServiceid(),tenant.getAmount(),OtherPayments.this);
                        break;
                    default:
                        break;
                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (result.equals("success")){
                                ...
                                Intent intents = new Intent(context, OtherPayments.class);
                                finish();
